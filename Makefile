...
M_SRC = minishell.c env_check.c signals.c garbage.c start.c lexer.c lexer_loop.c lexer_merge.c lexer_helpers.c builtins.c helpers.c execuator.c exec_utils.c exec_init.c tokens.c debug.c
