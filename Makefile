...
M_SRC = minishell.c env_check.c signals.c garbage.c start.c lexer.c builtins.c builtin_cmds.c builtin_cmds1.c helpers.c execuator.c exec_utils.c exec_init.c exec_redirs.c tokens.c debug.c
